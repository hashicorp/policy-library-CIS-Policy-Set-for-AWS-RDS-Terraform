...
This rule is covered by the [rds-encryption-at-rest-enabled](https://github.com/hashicorp/policy-library-CIS-Policy-Set-for-AWS-RDS-Terraform/blob/main/policies/rds-encryption-at-rest-enabled.sentinel) policy.
